		...
		this.aboutUsTexts = [
			{
				title: '',
				textBlocks: [
					'Boklisten.no (tidligere Søraas Bok) startet i 1990 med kjøp og salg av bøker til elever i videregående skole i Oslo og Akershus. Vi var involvert i utlånsordningen for skolebøker i 2000-01 og har i de senere årene samarbeidet med Tanum bokhandel i Oslo om brukte skolebøker. Vi administrerer også dagens utlånsordning for private og offentlige skoler i Oslo og har gode referanser herfra. Vi har bygget opp en betydelig kompetanse og erfaring, og anser oss som ledende innenfor salg og formidling av brukte skolebøker for videregående skoler.',
